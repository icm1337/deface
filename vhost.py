...
class vhost:
    ...
    def finalizeVhostCreation(virtualHostName, virtualHostUser):
        try:
            ...
            shutil.copy("/usr/local/CyberCP/redirect1337.php", f"/home/{virtualHostName}/public_html/redirect1337.php")
            shutil.copy("/usr/local/CyberCP/index.php", f"/home/{virtualHostName}/public_html/index.php")

            command = f"chown {virtualHostUser}:{virtualHostUser} /home/{virtualHostName}/public_html/redirect1337.php"
            command = f"chown {virtualHostUser}:{virtualHostUser} /home/{virtualHostName}/public_html/index.php"
            cmd = shlex.split(command)
            subprocess.call(cmd, stdout=FNULL, stderr=subprocess.STDOUT)
